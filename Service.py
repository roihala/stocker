...
if check_if_running('python3', 'alert.py'):
    print('Exit Check Alert.py')

else:
    print('Ignite Alert')
    subprocess.Popen(shlex.split(
        "python3 /home/debian/lib/stocker/alert.py --uri mongodb://admin:admin123@localhost:27017/stocker --token 1177225094:AAGtBg9BzIJVVXHelSSYnaQB6HBhyG1obiQ"),
