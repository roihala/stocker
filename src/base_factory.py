...
class BaseFactory(object):
    ...
    #     if name in BaseFactory.TICKER_COLLECTIONS:
    #         return BaseFactory._instantiate(BaseFactory.TICKER_COLLECTIONS[name][BaseFactory.COLLECTOR_INDEX], args, kwargs)
    #     elif name in BaseFactory.RECORDS_COLLECTIONS:
    #         return BaseFactory._instantiate(BaseFactory.RECORDS_COLLECTIONS[name][BaseFactory.COLLECTOR_INDEX], args, kwargs)
    #
    # @staticmethod
    # def alerters_factory(name, *args, **kwargs) -> AlerterBase:
    #     if name in BaseFactory.TICKER_COLLECTIONS:
    #         return BaseFactory._instantiate(BaseFactory.TICKER_COLLECTIONS[name][BaseFactory.ALERTER_INDEX], args, kwargs)
    #     elif name in BaseFactory.RECORDS_COLLECTIONS:
    #         return BaseFactory._instantiate(BaseFactory.RECORDS_COLLECTIONS[name][BaseFactory.ALERTER_INDEX], args, kwargs)
    #
    # @staticmethod
    # def readers_factory(name, *args, **kwargs) -> ReaderBase:
    #     return BaseFactory._instantiate(BaseFactory.TICKER_COLLECTIONS[name][BaseFactory.READER_INDEX], args, kwargs)
    #
    @staticmethod
    ...
    #     return [value[BaseFactory.COLLECTOR_INDEX] for value in BaseFactory.TICKER_COLLECTIONS.values()]
    #
    # @staticmethod
    # def get_collector(name):
    #     if name in BaseFactory.TICKER_COLLECTIONS:
    #         return BaseFactory.TICKER_COLLECTIONS[name][BaseFactory.COLLECTOR_INDEX]
    #     elif name in BaseFactory.RECORDS_COLLECTIONS:
    #         return BaseFactory.RECORDS_COLLECTIONS[name][BaseFactory.COLLECTOR_INDEX]
    #
    # @staticmethod
    # def get_alerter(name):
    #     if name in BaseFactory.TICKER_COLLECTIONS:
    #         return BaseFactory.TICKER_COLLECTIONS[name][BaseFactory.ALERTER_INDEX]
    #     elif name in BaseFactory.RECORDS_COLLECTIONS:
    #         return BaseFactory.RECORDS_COLLECTIONS[name][BaseFactory.ALERTER_INDEX]
#