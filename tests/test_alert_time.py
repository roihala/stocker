...
from collect import alert_tickers, extract_tickers
from src.collect.tickers import TickerCollector
    ...
    def test_no_history(self):
        ...
        for ticker in tickers:
            try:
                ...
                TickerCollector.BADGES_SITE.get_ticker_url(ticker)

                site = urllib.request.urlopen(TickerCollector.BADGES_SITE.get_ticker_url(ticker))
